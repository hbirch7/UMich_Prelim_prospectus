...
% 9 Jul 2020
% Github repo forked 2022/11/23
%https://github.com/meluso/UMich_Dissertation_Template
...
% Author email
\email{hbirch@umich.edu}

% Author ORCID iD
\orcid{0000-0001-7476-8045}
...
% Committee
\committee{ %
Professor Bj{\"o}rn Penning, Chair \\
Professor Wolfgang Lorenzon\\
Professor Joshua Spitz
}

% Chair must be entered separately for formatting reasons.
\chair{Professor Bj{\"o}rn Penning}
...
% Some abstract text
\abstract{\input{front_materials/abstract}}
...
\input{chapters/DM_Overview.tex}
\input{chapters/PhysicsTopic.tex}
\input{chapters/LZ_Exp.tex}
\input{chapters/OCS.tex}
\input{chapters/SPhE.tex}
\input{chapters/OD_Topology.tex}
\input{chapters/Muons.tex}
